...
class WineItemAdmin(admin.ModelAdmin):
    list_display = ('name', 'bottle_image_thumbnail_html', 'label_type', 'price', 'description', 'wine_type', 'varietal', 'origin')
    list_editable = ('label_type','wine_type', 'varietal', 'origin')
